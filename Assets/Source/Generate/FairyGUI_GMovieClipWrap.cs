...
public class FairyGUI_GMovieClipWrap
{
	...
	static int SetPlaySettings(IntPtr L)
	{
		try
		{
			...
			FairyGUI.GMovieClip obj = (FairyGUI.GMovieClip)ToLua.CheckObject(L, 1, typeof(FairyGUI.GMovieClip));
	...
	static int get_onPlayEnd(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onPlayEnd on a nil value" : e.Message);
		}
	}
