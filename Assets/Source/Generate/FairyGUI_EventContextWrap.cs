...
public class FairyGUI_EventContextWrap
{
	...
	static int get_isDefaultPrevented(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isDefaultPrevented on a nil value" : e.Message);
		}
	}
	...
	static int get_inputEvent(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index inputEvent on a nil value" : e.Message);
		}
	}
