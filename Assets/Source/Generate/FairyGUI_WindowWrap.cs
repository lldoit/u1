...
public class FairyGUI_WindowWrap
{
	...
	static int get_closeButton(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index closeButton on a nil value" : e.Message);
		}
	}
	...
	static int get_isTop(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isTop on a nil value" : e.Message);
		}
	}
	...
	static int get_modal(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index modal on a nil value" : e.Message);
		}
	}
