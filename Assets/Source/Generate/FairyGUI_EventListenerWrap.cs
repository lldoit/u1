...
public class FairyGUI_EventListenerWrap
{
	...
	static int _CreateFairyGUI_EventListener(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				FairyGUI.EventDispatcher arg0 = (FairyGUI.EventDispatcher)ToLua.CheckObject(L, 1, typeof(FairyGUI.EventDispatcher));
	...
	static int get_isDispatching(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isDispatching on a nil value" : e.Message);
		}
	}
}
