...
public class FairyGUI_GObjectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("gearDisplay", get_gearDisplay, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_gearDisplay(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GObject obj = (FairyGUI.GObject)o;
			FairyGUI.GearDisplay ret = obj.gearDisplay;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index gearDisplay on a nil value" : e.Message);
		}
	}
