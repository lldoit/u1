...
public class FairyGUI_InputEventWrap
{
	...
	static int get_modifiers(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index modifiers on a nil value" : e.Message);
		}
	}
	...
	static int get_mouseWheelDelta(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index mouseWheelDelta on a nil value" : e.Message);
		}
	}
	...
	static int get_touchId(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index touchId on a nil value" : e.Message);
		}
	}
	...
	static int get_isDoubleClick(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isDoubleClick on a nil value" : e.Message);
		}
	}
	...
	static int get_ctrl(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index ctrl on a nil value" : e.Message);
		}
	}
	...
	static int get_shift(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index shift on a nil value" : e.Message);
		}
	}
